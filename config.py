...
MAX_TX_HISTORY = int(os.getenv('MAX_TX_HISTORY', '10'))  # Number of transactions to check

# Rate limiting settings
API_RETRY_DELAY = 1  # Seconds to wait after rate limit
WALLET_CHECK_DELAY = 0.1  # Seconds between wallet checks
