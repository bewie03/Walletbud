                ...
                try:
                    ...
                    try:
                        ...
                        await self.rate_limited_request(
                            self.blockfrost_client.specific_address_assets,  # Correct method name
                            address=address
                        )
    ...
    async def init_blockfrost(self):
        ...
        try:
            ...
            try:
                ...
                await loop.run_in_executor(None, self.blockfrost_client.specific_address_assets, "addr1qxqs59lphg8g6qndelq8xwqn60ag3aeyfcp33c2kdp46a09re5df3pzwwmyq946axfcejy5n4x0y99wqpgtp2gd0k09qsgy6pz")  # Test with a known address
        ...
        try:
            async with self.wallet_task_lock:
                ...
                assets = await self.rate_limited_request(
                    self.blockfrost_client.specific_address_assets,  # Fixed method name
                    address=address
                )
                ...
                txs = await self.rate_limited_request(
                    self.blockfrost_client.specific_address_transactions,  # Fixed method name
                    address=address,
